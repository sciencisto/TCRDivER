"""
Counting script for all the Benny Chain samples: 
...
python3 count_Chain_data.py /path_to_wdir/ 
...
def write_out_Chain_tsv_file(wdir_path, fname, cdr3_count_dict):
...
if __name__ == '__main__':
	...
	for file_name in files:
		...
		# WRITE OUT FILE 
		write_out_Chain_tsv_file(wdir_path, file_name, cdr3_count_dict)
	# EXIT
